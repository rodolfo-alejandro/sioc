...
def _serialize_marker(row: DenunciaWeb) -> dict:
    return {
        ...
        "investigados": row.investigados or "",
        "fecha_sol_allanamiento": row.fecha_sol_allanamiento.strftime("%Y-%m-%d") if row.fecha_sol_allanamiento else "",
        "fecha_desestimada": row.fecha_desestimada.strftime("%Y-%m-%d") if row.fecha_desestimada else "",
        "latitud": row.latitud,
