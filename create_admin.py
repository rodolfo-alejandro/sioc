...
ADMIN_PERM_CODES = [
    ...
    'BASE_OPERATIVA_VIEW', 'BASE_OPERATIVA_IMPORT',
...
def create_seed_data(*, create_tables: bool = True):
    ...
    with app.app_context():
        ...
        permisos = [
            ...
            ('BASE_OPERATIVA_VIEW', 'Ver base operativa Capital/Interior'),
            ('BASE_OPERATIVA_IMPORT', 'Importar Excel de base operativa'),
